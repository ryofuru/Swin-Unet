...
def trainer_gapgrid(args, model, snapshot_path):
    ...
    train_samples, val_samples = build_samples(args.data_dirs)
    db_train = GapGridDataset(train_samples, patch_size=args.img_size, split='train')
    db_val   = GapGridDataset(val_samples,   patch_size=args.img_size, split='val')
