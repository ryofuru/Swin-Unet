"""
Debug script: run inference on the center 224x224 patch of the vit-infer image
and save a visualization in the same format as trainer_gapgrid samples.

Columns: h_phase | v_phase | colored_G | code (raw) | mask M | code (masked) | Pred
Output:  model_out/gapgrid/samples-debug/<fname>_center.png
"""
...
def build_arg_parser():
    ...
    p.add_argument('--output_dir',  default='model_out/gapgrid/samples-debug')
...
def main():
    ...
    for fname in fnames:
        ...
        # Build mask on full image, then apply
        ...
        print(f'Saved: {out_path}  (center patch top={top}, left={left})')
